...
If all the parameters of an parameterized type are of the mode that they are supposed to be then this type is of the mode it's supposed to be, this holds whether the type is abstract or not.
